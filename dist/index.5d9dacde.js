...
var _ymaps3Js = require("./modules/ymaps3.js");

},{"./modules/accordion.js":"hMX0x","./modules/modal.js":"lfRJE","./modules/validation.js":"5Gsoy","./modules/ymaps3.js":"35SKR"}],"hMX0x":[function(require,module,exports) {
...
textWrapper.forEach((elem)=>{
    if (heightWrapper < elem.scrollHeight) heightWrapper = elem.scrollHeight;
});
buttons.forEach((btn, index)=>{
    btn.addEventListener("click", ({ target })=>{
        for(let i = 0; i < items.length; i += 1)if (index === i) {
            textWrapper[i].style.height = items[i].classList.contains("faq--active") ? "" : `${heightWrapper}px`;
        ...
        if (target.matches(".faq__btn")) buttons.forEach((btn)=>{
            if (btn === target) {
...
},{}],"lfRJE":[function(require,module,exports) {
...
modal.addEventListener("click", ({ target })=>{
    if (target === modal || target.closest(".modal-window--close")) modal.classList.add("modal-window--visible");
});

},{}],"5Gsoy":[function(require,module,exports) {
...
const justValidate = new (0, _justValidateDefault.default)(".booking__form");
justValidate.addField("#name-input", [
    {
        rule: "required",
...
},{"inputmask":"gyYno","just-validate":"gcCDD","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"gyYno":[function(require,module,exports) {
/*!
 * dist/inputmask
...
},{}],"gcCDD":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
...
class JustValidate {
    ...
    validateHandler(ev, forceRevalidation = false) {
        ...
        return this.validate(forceRevalidation).finally(()=>{
            ...
            else (_b = this.onFailCallback) == null || _b.call(this, this.getCompatibleFields(), this.groupFields);
        });
    }
    setForm(form) {
        this.form = form;
...
},{}],"35SKR":[function(require,module,exports) {
/* eslint-disable require-jsdoc */ // Yandex map 3.0
let map = null;
...
},{}]},["iNGHL","1Z4Rq"], "1Z4Rq", "parcelRequire076d")
